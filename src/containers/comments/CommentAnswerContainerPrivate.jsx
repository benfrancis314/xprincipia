    ...
    if (this.props.params.solutionID){
        return (
            <div id="answerContainer">
                ...
                {this.props.children}
                <CommentProposalUnitPrivate comments={this.state.comments} probID={this.props.params.probID} solutionID={this.props.params.solutionID} suggID={this.props.params.answerID} commentID={this.props.params.commentID} />
            </div>);
