...
import SubProjectUnitProposalPrivate from '../components/problems/SubProjectUnitProposalPrivate.jsx';
        ...
        /*if (this.props.params.solutionID) {
            ...
            return (
                <div>
                    ...
                    <div id="sidebarSBProjects">
                        <SubProjectUnitProposalPrivate problems={this.state.problems} probID={this.props.params.probID} solutionID={this.props.params.solutionID} />
                    </div>
                </div>
            );
        }
