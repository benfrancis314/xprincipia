...
import ErProjectUnit from '../../components/teams/ErProjectUnit.jsx';
import {Config} from '../../config.js';
import $ from 'jquery';

export default class ErProjectsContainer extends React.Component {
            ...
            return (
                <div>
                    <div id="sidebarSBProjects">
                        <ErProjectUnit problems={this.state.userproblems}/>
                    </div>
