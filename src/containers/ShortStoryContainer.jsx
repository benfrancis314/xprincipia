          ...
          <div id="storySection1">
            <div id="story1Logo1">
              <span id="storyCapitalProse1">it was the year of the discovery</span>. 
                Unlike the great discoveries of the past, this came not with a flash or moment of inflection, nor with any proceeding hysteria; this discovery came silently, <i>gently</i> upon the populace. 
                ...
                This became known, affectionately, as <i>pebbles over boulders</i>. 
                ...
                It was in the midst of this <i>Second Age of Discovery</i> that another great theory emerged; some even claim upon accident. 
                <br />
                <br />
            </div>
              <div id="story1Logo2">
                  ...
                  Arguments were made against the feat immediately; <i>Gödel</i> was invoked in oft erroneous objections, yet the theory held its ground against even the most stern challenges. 
                  However, just as the footing of this movement began to firm, a new, equally accidental discovery was made. 
                  Through an unconventional manipulation of one of the equations, which was singularly esoteric in nature, came something <i>unsettling</i>. 
                  <br />
                  <br />
              </div>
              <div id="story1Logo3">
                  ...
                  This new finding, completed by a now-famed post-doc, found something <i>unaccounted</i> for. 
                  ...
                  And so a month of philosophizing began; while <i>I</i> set out at work. 
                  ...
                  I also knew that <i>whoever</i> would invent this method, and use it for the first time, was destined for historical glory. 
                  And this is why <i>I</i> alone will do so.                   
                  <br />
                  <br />
                </div>
                <div id="story1Logo5">
                  ...
                  Curiously enough, with the proper configurations, it appears this variability can <i>maximize</i> the effects of consciousness, given the current anatomical status of human brains. 
                  It is, still today, debated as to what this entirely means. 
                  <br />
                  <br />
                  But I digress, partly in my nerves. 
                  I have gathered myself alone on this fateful day, for this timelessly important experiment. 
                ...
                <div id="story1Logo6">
                  ...
                  At approximately the time of my finishing of the vial, I noticed the beginnings of a new <i>peculiarity</i>. 
              ...
              <div id="storySection2">
                <div id="story2Logo1">
                  ...
                  A mission to another star, but Alpha Centauri would be her first. 
                  Hope lacked the experience to understand why their mission was so important or the true magnificence and accomplishment of interstellar travel. 
                  She spent her days, for lack of a better term, analyzing the data that they received from the unmanned ships sent before them. It was on a normal day that she encountered the first anomaly, one of those life changing happenings that makes you forget that someone had spilt coffee on you that morning. 
                  <i> Squares</i>. 
                  Almost perfect squares. 
                  That’s all anyone could make out from the photo. 
                ...
                <div id="story2Logo2">
                  ...
                  Large figures had been carved or cut out of the local landscape, a giant:<span id="storyAlegreya"> we’re here, find us</span>, to the sky. 
                  These signs were, to Hope, the first gasping breaths of a baby, there was <i>life</i>. 
                  She spent hours contemplating what society must be like there, how the two civilizations meeting would change everything. 
                  For the first time in her life she felt truly alive and purposeful, in a way that only a vindicated daydream arriving at reality can make you feel.
                  <br />
                  <br />
                </div>
                <div id="story2Logo3">
                  The decisions however, were not left to Hope, hers was the work of analysis. 
                  She studied meticulously to compile her report. 
                  ...
                  She finished her report, deviating from procedure by adding an appendix detailing ways she had dreamt up about how to best interact and aide the planet’s young society. 
                  Feeling as if she were both mother and teacher to every being on this far away planet, she sent in her report.
                </div>
              </div>
              <div id="storySection1">
                <br />
                <div id="story1Logo7">
                  ...
                  The effects betrayed a certain <i>iridescence</i>, of which I cannot place in regards to comparison. 
                ...
                <div id="story1Logo11">
                  ...
                  As my thoughts and logic grasped and took aim at recovery, I saw what I knew would complete their state of utter disrepair: An <i>entity</i>, of which I dare not call anything more, was suspended just meters from my very location! 
                  I cannot evade the feeling that I was <i>anticipated</i>. 
                ...
                <div id="story1Logo13">
                  ...
                  As I sat in ghast, before my eyes was <i>the</i> knowledge, the eternal answers we had always sought, even to questions unasked; it was part equation in form, describing an aeon-matured omniscience, yet also, through uncomfortable yet <i>distinctly</i> apparent suggestions, a glimpse of many deeper, stranger laws that could not be accounted for or classified. 
                  <br />
                  <br />
                </div>
                <div id="story1Logo14">
                  ...
                  Here it deposited me and gathered with others of its kind, now coalescing in multiple series of sharp, concentric ellipses about a center to the space; and it was here that I looked and saw what may only be described as <i>God</i>, or possibly the <i>source</i> of God, as humans construct it. 
                  This <i>mecca</i>-structure, visually represented as sets of eccentric spherical vortices, seemed to guide the flow of all entelechial information; <i>this</i> was surely the supreme achievement of this distant species, either crafted or discovered, over the millennia in this distant space. 
                  <br />
                  <br />
                </div>
                <div id="story1Logo15">
                  ...
                  Whatever forces possessed this eternal realm, I knew not, but as I glanced down at the now-<i>millions</i> of alien forms among me, each hovering and dancing feverishly about the centralized monolith, I no longer cared. 
                  <br />
                </div>
              </div>
              <div id="storySection2">
                <div id="story2Logo4">
                  ...
                  The planet was right in front of them now, so close she tried to reach out and touch it. 
                  ...
                  She still dreamt of being their great teacher, their guardian angel.
                  <br />
                  <br />
                </div>
                <div id="story2Logo5">
                  ...
                  Let them grow on their own and when the time was right, when they reached the milestone of consciousness, greet them as equals. 
                  They had been so close, and now Hope would never set foot on <i>any</i> planet in her lifetime. 
                ...
                <div id="story2Logo7">
                  ...
                  It appeared, by the metrics used, that the civilization never seemed to progress any further. 
                  After years of waiting, and a strange silence from the decision makers on Earth, the first ship finally chose to land upon the planet. 
                  Upon their descent, an eerie silence fell over the crew; the world beneath was still, much more still than they had anticipated. 
                  The broad strokes they had seen as war and society appeared almost automated, relics of a lost time. 
                  Breathlessly in the alien night they approached the centralized hub of phantom activity, and found <i>them</i>, motionless. 
                  <br />
                  <br />
                </div>
                <div id="story2Logo8">
                  ...
                  <i> Squares</i>? 
                  No, they had merely seen coarse boulders overhead; the sheer advancement of Proxima Centauri b revealed itself only in the distant, alien pebbles below. 
                </div>
              </div>
          </div>
          <div id="storyEnd">
