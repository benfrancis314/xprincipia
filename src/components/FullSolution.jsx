...
export default class FullSolution extends React.Component {
  constructor(props){
    ...
    componentDidMount(){
      var self = this;
      return axios.get('http://ec2-13-58-19-50.us-east-2.compute.amazonaws.com/auth/solutions/ID?id='+this.props.params.solutionID).then(function (response) {
          self.setState({
  ...
  componentWillReceiveProps(newProps){
    var self = this;
      return axios.get('http://ec2-13-58-19-50.us-east-2.compute.amazonaws.com/auth/solutions/ID?id='+newProps.params.solutionID).then(function (response) {
          self.setState({
              solutionInfo: response.data,  
          })
    })
