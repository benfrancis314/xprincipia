      ...
      return (
        <div>
            ...
            <div id="projectFormButtonContainer">
                <Link to={`/project/private/${this.props.params.probID}/proposal/${this.props.params.solutionID}/create`} activeClassName="activeProjectFormButtonLeft">
                    <div id="projectFormButtonLeft">
                        new
                    </div>
                </Link>
                <Link to={`/project/private/${this.props.params.probID}/proposal/${this.props.params.solutionID}/link`} activeClassName="activeProjectFormButtonRight">
