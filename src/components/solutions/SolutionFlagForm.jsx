...
export default class SolutionFlagForm extends React.Component {
  ...
  constructor(){
    ...
    this.flagProposal = this.flagProposal.bind(this);
  };
      ...
      return (
        <div id="flagContainer">
          ...
          <form id="flagForm">
            ...
            autoFocus ></textarea>
            <br />
            <div onClick={this.flagProposal} id="flagButton">submit</div>
