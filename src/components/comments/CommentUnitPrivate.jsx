...
export default class CommentUnitPrivate extends React.Component {
       ...
       if (this.state.voteHash[comment.ID] === true && comment.Username === cookie.load('userName')) {
           return (
            <li key={comment.ID} id="answerUnit">
                ...
                <Link to={`/project/private/${this.props.probID}/suggestion/${this.props.suggID}/comment/${comment.ID}/delete`}>
                    <div id="deleteSBButton">
                        <img src={require('../../assets/delete.svg')} id="editLogo" width="18" height="18" alt="Delete Button" />
                    </div>
                </Link>
                <Link to={`/project/private/${this.props.probID}/suggestion/${this.props.suggID}/comment/${comment.ID}/edit`}>
