       ...
       if (this.state.voteHash[comment.ID] === true && comment.Username === cookie.load('userName')) {
           return (
            <li key={comment.ID} id="answerUnit">
                ...
                <Link to={`/project/${this.props.probID}/proposal/${this.props.solutionID}/suggestion/${this.props.suggID}/comment/${comment.ID}/delete`}>
                    <div id="deleteSBButton">
                        <img src={require('../../assets/delete.svg')} id="editLogo" width="18" height="18" alt="Delete Button" />
                    </div>
                </Link>
                <Link to={`/project/${this.props.probID}/proposal/${this.props.solutionID}/suggestion/${this.props.suggID}/comment/${comment.ID}/edit`}>
