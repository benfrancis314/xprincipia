      ...
      .catch(function (error) {
       ...
       <li key={comment.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={comment.ID}>
                    <Link to={`/project/private/${comment.TypeID}/proposal/${this.props.solutionID}/comment/${comment.ID}/subcomments`}>
                    ...
                    <Link to={`/project/private/${comment.TypeID}/proposal/${this.props.solutionID}/comment/${comment.ParentID}/subcomment/${comment.ID}/edit`}>
                        <div id="editDiscussButton" onMouseOver={hoverEditVoted} onMouseOut={unHoverEditVoted}>
                            <img src={require('../../assets/editBlue.svg')} id="editLogo" width="18" height="18" alt="Edit Button" />
                        </div>
                    </Link>
                    <Link to={`/project/private/${comment.TypeID}/proposal/${this.props.solutionID}/comment/${comment.ParentID}/subcomment/${comment.ID}/delete`}>
       ...
       <li key={comment.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={comment.ID}>
                    ...
                    <Link to={`/project/private/${comment.TypeID}/proposal/${this.props.solutionID}/comment/${comment.ParentID}/subcomment/${comment.ID}/flag`}>
