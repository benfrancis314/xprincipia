...
export default class LearnResourcesUnit extends React.Component {
      ...
      .catch(function (error) {
       ...
       <li key={resource.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={resource.ID}>
                    <Link to={`/project/${resource.TypeID}/learn/resource/${resource.ID}/comments`}>
                    ...
                    <Link to={`/project/${resource.TypeID}/learn/resource/${resource.ID}/edit`}>
                        <div id="editDiscussButton" onMouseOver={hoverEditVoted} onMouseOut={unHoverEditVoted}>
                            <img src={require('../../assets/editBlue.svg')} id="editLogo" width="18" height="18" alt="Edit Button" />
                        </div>
                    </Link>
                    <Link to={`/project/${resource.TypeID}/learn/resource/${resource.ID}/delete`}>
       ...
       <li key={resource.ID} id="suggestionUnit">
				<div id={'suggestionContent'} className={resource.ID}>
					...
					<div id="resourceHeader">
                        <span id="discussPercent">{floatToDecimal(resource.PercentRank)}</span>
					    <span id="resourceTitleText">{resource.Title}</span> 
                    </div>
       ...
       <li key={resource.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={resource.ID}>
                    ...
                    <Link to={`/project/${resource.TypeID}/learn/resource/${resource.ID}/flag`}>
