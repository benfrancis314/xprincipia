...
//                     </div>
//                 </Link>
//                 {/*<Link to={`/project/private/private/${learnItem.TypeID}/learn/content/${learnItem.ID}/comments`}>
...
//                     </div>
// 				</div>
//                     {/*<Link to={`/project/private/private/${learnItem.TypeID}/learn/contentItem/${learnItem.ID}/flag`}>
//                         <div id="flagSBButton">
//                             <img src={require('.../src/assets/flag.svg')} id="deleteLogo" width="11" height="11" alt="Delete Button, Red X" />
//                             Flag
//                         </div>
//                     </Link>*/}
//                 {/*<Link to={`/project/private/private/${learnItem.TypeID}/learn/content/${learnItem.ID}/comments`} activeClassName="activeBlue">
//                     <div id="commentSBButtonUser">
//                             <img src={require('../../assets/comments.svg')} id="commentLogo" width="24" height="24" alt="Comments Button" />
//                     </div>                
//                 </Link>*/}
