      ...
      .catch(function (error) {
       ...
       <li key={answer.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={answer.ID}>
                    <Link to={`/project/${this.props.probID}/question/${this.props.questID}/answer/${answer.ID}/comments`}>
                    ...
                    <Link to={`/project/${this.props.probID}/question/${this.props.questID}/answer/${answer.ID}/edit`}>
                        <div id="editDiscussButton" onMouseOver={hoverEditVoted} onMouseOut={unHoverEditVoted}>
                            <img src={require('../../assets/editBlue.svg')} id="editLogo" width="18" height="18" alt="Edit Button" />
                        </div>
                    </Link>
                    <Link to={`/project/${this.props.probID}/question/${this.props.questID}/answer/${answer.ID}/delete`}>
       ...
       <li key={answer.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={answer.ID}>
                    ...
                    <Link to={`/project/${this.props.probID}/question/${this.props.questID}/answer/${answer.ID}/flag`}>
