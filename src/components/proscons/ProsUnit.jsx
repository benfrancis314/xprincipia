      ...
      .catch(function (error) {
       ...
       <li key={pro.ID} id="prosConsUnit">
				<div id="suggestionContentHoverVote" className={pro.ID}>
                    <Link to={`/project/${this.props.probID}/proposal/${pro.TypeID}/pros/${pro.ID}/comments`}>
                    ...
                    <Link to={`/project/${this.props.probID}/proposal/${pro.TypeID}/pros/${pro.ID}/edit`}>
                        <div id="editDiscussButton" onMouseOver={hoverEditVoted} onMouseOut={unHoverEditVoted}>
                            <img src={require('../../assets/editBlue.svg')} id="editLogo" width="18" height="18" alt="Edit Button" />
                        </div>
                    </Link>
                    <Link to={`/project/${this.props.probID}/proposal/${pro.TypeID}/pros/${pro.ID}/delete`}>
       ...
       <li key={pro.ID} id="prosConsUnit">
				<div id="suggestionContentHoverVote" className={pro.ID}>
                    ...
                    <Link to={`/project/${this.props.probID}/proposal/${pro.TypeID}/pros/${pro.ID}/flag`}>
