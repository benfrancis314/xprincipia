      ...
      .catch(function (error) {
       ...
       <li key={con.ID} id="prosConsUnit">
				<div id="suggestionContentHoverVote" className={con.ID}>
                    <Link to={`/project/private/${this.props.probID}/proposal/${con.TypeID}/cons/${con.ID}/comments`}>
                    ...
                    <Link to={`/project/private/${this.props.probID}/proposal/${con.TypeID}/cons/${con.ID}/edit`}>
                        <div id="editDiscussButton" onMouseOver={hoverEditVoted} onMouseOut={unHoverEditVoted}>
                            <img src={require('../../assets/editBlue.svg')} id="editLogo" width="18" height="18" alt="Edit Button" />
                        </div>
                    </Link>
                    <Link to={`/project/private/${this.props.probID}/proposal/${con.TypeID}/cons/${con.ID}/delete`}>
       ...
       <li key={con.ID} id="prosConsUnit">
				<div id="suggestionContentHoverVote" className={con.ID}>
                    ...
                    <Link to={`/project/private/${this.props.probID}/proposal/${con.TypeID}/cons/${con.ID}/flag`}>
...
//                     </div>
// 				</div>
//                     <Link to={`/project/private/${this.props.probID}/${con.TypeID}/cons/${con.ID}/delete`}>
//                         <div id="deleteSBButton">
//                             <img src={require('../../assets/delete.svg')} id="editLogo" width="18" height="18" alt="Delete Button" />
//                         </div>
//                     </Link>
//                     <Link to={`/project/private/${this.props.probID}/${con.TypeID}/cons/${con.ID}/edit`}>
