      ...
      .catch(function (error) {
       ...
       <li key={suggestion.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={suggestion.ID}>
                    <Link to={`/project/${this.props.probID}/proposal/${suggestion.TypeID}/suggestion/${suggestion.ID}/comments`}>
                    ...
                    <Link to={`/project/${this.props.probID}/proposal/${suggestion.TypeID}/suggestion/${suggestion.ID}/edit`}>
                        <div id="editDiscussButton" onMouseOver={hoverEditVoted} onMouseOut={unHoverEditVoted}>
                            <img src={require('../../assets/editBlue.svg')} id="editLogo" width="18" height="18" alt="Edit Button" />
                        </div>
                    </Link>
                    <Link to={`/project/${this.props.probID}/proposal/${suggestion.TypeID}/suggestion/${suggestion.ID}/delete`}>
       ...
       <li key={suggestion.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={suggestion.ID}>
                    ...
                    <Link to={`/project/${this.props.probID}/proposal/${suggestion.TypeID}/suggestion/${suggestion.ID}/flag`}>
...
//                     </div>
//                 </Link>
//                 <Link  to={`/project/${this.props.probID}/proposal/${suggestion.TypeID}/suggestion/${suggestion.ID}/comments`} activeClassName="activeBlue">
