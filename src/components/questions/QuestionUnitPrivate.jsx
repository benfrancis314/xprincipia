      ...
      .catch(function (error) {
       ...
       <li key={question.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={question.ID}>
                    <Link to={`/project/private/${question.TypeID}/question/${question.ID}/answers`}>
                    ...
                    <Link to={`/project/private/${question.TypeID}/questions`}>
       ...
       <li key={question.ID} id="suggestionUnit">
				<div id="suggestionContentHoverVote" className={question.ID}>
                    ...
                    <Link to={`/project/private/${question.TypeID}/question/${question.ID}/flag`}>
